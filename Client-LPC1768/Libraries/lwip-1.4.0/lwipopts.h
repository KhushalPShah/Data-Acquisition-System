...
#define PBUF_POOL_SIZE                  16 // 16 reduz consideravelmente utilização de memória
#define PBUF_POOL_BUFSIZE               72 // 72 reduz consideravelmente utilização de memória
//#define ARP_TABLE_SIZE                  2
#define IP_REASS_BUFSIZE                600
//#define TCP_WND                         1024
//#define TCP_QUEUE_OOSEQ                 0
#define LWIP_ASSERT                       1
#define TCP_SND_BUF						516

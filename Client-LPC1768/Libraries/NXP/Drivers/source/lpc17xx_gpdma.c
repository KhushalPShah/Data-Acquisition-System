...
uint32_t GPDMA_CalcTxControl(uint32_t transfer_size, uint32_t dst_conn)
{
     return GPDMA_DMACCxControl_TransferSize(transfer_size) \
	  | GPDMA_DMACCxControl_SBSize((uint32_t)GPDMA_LUTPerBurst[dst_conn]) \
	  | GPDMA_DMACCxControl_DBSize((uint32_t)GPDMA_LUTPerBurst[dst_conn]) \
	  | GPDMA_DMACCxControl_SWidth((uint32_t)GPDMA_LUTPerWid[dst_conn]) \
	  | GPDMA_DMACCxControl_DWidth((uint32_t)GPDMA_LUTPerWid[dst_conn]) \
	  | GPDMA_DMACCxControl_SI \
	  | GPDMA_DMACCxControl_I;
}
